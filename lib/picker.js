            ...
            open: function( dontGiveFocus ) {
                ...
                if ( dontGiveFocus !== false ) {
                    ...
                    $document.on( 'click.P' + STATE.id + ' focusin.P' + STATE.id, function( event ) {
                        ...
                        //   to the doc. So make sure the target wasn't the doc. Also check for related target
                        // in case the event target was "intercepted" by a higher element (e.g. modal overlays)
                        if ( event.target != ELEMENT && event.target != document ) 
